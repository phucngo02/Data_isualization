...
def test_qld_single_station_Level(len_b, len_a, graphs):
    ...
    x_samples, y_samples, x_len, x_before_len = train_val_test_generate(df_test_one, test_sampling_params)
...
if __name__ == "__main__":
  len_a, len_b, graphs = 20, 20, 15
  _,_,_ = test_qld_single_station_Level(len_a, len_b, graphs)
